...
CREATE POLICY "Anyone can view sidejob images" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'sidejob-cards'::"text"));



CREATE POLICY "Users can upload sidejob images" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'sidejob-cards'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));
...
CREATE POLICY "sidejob_cards_delete" ON "storage"."objects" FOR DELETE TO "authenticated" USING (("bucket_id" = 'sidejob-cards'::"text"));



CREATE POLICY "sidejob_cards_insert" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK (("bucket_id" = 'sidejob-cards'::"text"));



CREATE POLICY "sidejob_cards_select" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'sidejob-cards'::"text"));



CREATE POLICY "sidejob_cards_update" ON "storage"."objects" FOR UPDATE TO "authenticated" USING (("bucket_id" = 'sidejob-cards'::"text")) WITH CHECK (("bucket_id" = 'sidejob-cards'::"text"));
